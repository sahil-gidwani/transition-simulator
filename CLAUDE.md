...
5. **One consistent horizon.** "Value after" = the first valuation from 6 months post-transfer, accepted up to 18 months (nominal 12-month horizon; realized median ≈10 months) — one rule for every comp, everywhere.
